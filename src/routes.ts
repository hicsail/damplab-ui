...
export default [
  ...
  layout("./layouts/PrivateRouteAuthed.tsx", [
    ...
    route("/notification-preferences", "./pages/NotificationPreferences.tsx"),
  ...
  layout("./layouts/PrivateRouteCatalogEditor.tsx", [
    ...
    route(
      "/edit/services/:serviceId/parameters",
    ...
    route(
      "/edit/inventory/upload-history",
      "./pages/InventoryUploadHistory.tsx",
    ),

...
import { MARK_NOTIFICATION_READ, MARK_ALL_NOTIFICATIONS_READ } from '../gql/mutations';
...
export default function NotificationBell() {
  ...
  const notifications: NotificationItem[] = listData?.myNotifications?.items ?? [];
                ...
                <ListItemText
                  primary={
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <Typography variant="body2" fontWeight={n.readAt ? 400 : 600} noWrap sx={{ flex: 1 }}>
                        {n.title}
                      </Typography>

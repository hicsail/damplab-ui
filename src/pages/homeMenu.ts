 ...
 * label resembles. "Announcements" points at `/edit_announcements`, so it is
 * `announcements:write`, not the baseline `announcements:read`.
 *
...
export const HOME_MENU: readonly HomeMenuSectionDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'edit-announcements', label: 'Edit Announcements', to: '/edit_announcements', visible: needs(PERMISSIONS.AnnouncementsWrite) },
